      ...
      <main className="flex-grow flex items-center justify-center pt-24 pb-xl px-margin-mobile">
        ...
        <div className="w-full max-w-[440px]">
          <div className="bg-surface-container-lowest rounded-xl p-lg shadow-[0_4px_20px_rgba(0,0,0,0.04)] border border-surface-container flex flex-col items-center">
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center gap-md bg-surface-container-lowest border border-surface-container py-md rounded-lg font-label-md text-label-md text-on-background hover:bg-surface-container-low active:scale-[0.98] transition-all"
            >
